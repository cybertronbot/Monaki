...
function Hero() {
  return (
    <div className="xl:h-screen">
      ...
      <div className="">
        <div className="">
          <div className="flex justify-between xl:flex-row flex-col items-center xl:gap-0 gap-5 border-t-[1px] border-b-[1px] sm:v relative  border-[#fff] px-4  xl:px-14 w-full">
