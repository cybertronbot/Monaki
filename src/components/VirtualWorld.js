...
function VirtualWorld() {
  return (
    <div className="px-16 bg-[#FFF253] ">
      <div className="flex items-center relative">
        <div className="flex flex-1 border-r-[1px] border-[#000] py-10">
          <div className="p-[20px] bg-[#FFF89F] rounded-lg shadow-[8px_8px_0_0_#000]">
            ...
            <div className="bg-black pt-10 pr-[30px] rounded-[21px] ">
              <img src={nft} />
            </div>
        ...
        <div className="flex flex-1 flex-col pl-12">
          ...
          <h2 className="otf text-5xl text-[#7843E8] pt-[20px] pb-7">
            Rare <br /> Virtual World
          </h2>
          <h5 className="monument-ultra text-[18px]">Owned By OXOJ</h5>
          <p className="monument-ultra w-[561px] text-sm pt-[62px]">
